...
const ProjectCard = ({ index, name, description, tags, image, source_code_link }) => {
  return(
    <motion.div variants={fadeIn("up","spring", index*0.5,0.75)}>
      <Tilt options={{ max: 45,scale:1, speed:450 }} className="bg-tertiary p-5 rounder-2xl sm:w-[360px] w-full">
  ...
  return (
    ...
    <div className="w-full felx">
      <motion.p variants={fadeIn("","",0.1,1)} className="mt-3 text-secondary text-[17px] max-w-3xl leading-[30px]">
        following some of my recent projects on github 
        weijfoweifwoeifijefjw 
        wfwefnowiejfoiwejfwef
        oijsiodjfiosjdfsijdfiojsdofi
        efwegbidufudbuiesiofjseoifjsef
      </motion.p>
    </div>
